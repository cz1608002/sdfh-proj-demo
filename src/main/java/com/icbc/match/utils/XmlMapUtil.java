...
public class XmlMapUtil {
     ...
     * @param isCDATA 是否加入CDATA标识符 true:加入 false:不加入,一般用false
     * @return xml字符串
     */
...
//        String parentName = "xml";
     ...
     * (多层)xml格式字符串转换为map
     *
     * @param xml xml字符串  "<?xml version='1.0' encoding='UTF-8'?>"
...
//        StringBuffer stringBuffer = new StringBuffer();
        String xml = multilayerMapToXml(mapxml, false);
        ...
        Map map8 = multilayerXmlToMap(xml);
