...
public class DepositFixedPurchaseV1Service {
    ...
    public DepositFixedPurchaseResponseV1 execute(DepositFixedPurchaseRequestV1.DepositFixedPurchaseRequestV1Biz bizContent) {

        String serviceUrl = apiServer + ApiConstants.API_DEPOSIT_FIXED_PURCHASE_V1;
        ...
        try {
            DepositFixedPurchaseResponseV1 response = apiClientCopService.execute(request);
