...
public class DepositFixedTotalqueryV1Service {
    ...
    public DepositFixedTotalqueryResponseV1 execute(DepositFixedTotalqueryRequestV1.DepositFixedTotalqueryRequestV1Biz bizContent) {

        String serviceUrl = apiServer + ApiConstants.API_DEPOSIT_FIXED_TOTALQUERY_V1;
        ...
        try {
            DepositFixedTotalqueryResponseV1 response = apiClientCopService.execute(request);
